...
/* package rgb-color-model-0.1.0.0 */
#ifndef VERSION_rgb_color_model
#define VERSION_rgb_color_model "0.1.0.0"
#endif /* VERSION_rgb_color_model */
#ifndef MIN_VERSION_rgb_color_model
#define MIN_VERSION_rgb_color_model(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rgb_color_model */
...
#define CURRENT_PACKAGE_KEY "rgb-color-model-0.1.0.0-2olTCxd9gMJA44RAeydlIg"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "rgb-color-model-0.1.0.0-2olTCxd9gMJA44RAeydlIg"
